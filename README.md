        ...
        <div id="header-wrapper">
            <header id="header" class="header1 dt-menuoverslider">
                ...
                <div class="container">
                    ...
                    <!--logo starts-->
                    <div id="logo">
                        <a href="https://github.com/desenvolvedorIcotrade" title="Cleverton Softwares">
                            <img class="normal_logo" src="#" alt="Cleverton Softwares" title="Cleverton Softwares" id="dt_logo" />
                            <img class="retina_logo" src="#" alt="Cleverton Softwares" title="Cleverton Softwares" style="width:187px; height:46px;" id="dt_retina_logo" />
                        </a>
                    </div>
                    <!--logo ends-->
                    ...
                    <div id="menu-container">
                        ...
                        <nav id="main-menu">
                            <ul id="menu-header-menu" class="group menu">
                                ...
                                <li id="menu-item-486" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-depth-0 menu-item-simple-parent "><a href="https://github.com/desenvolvedorIcotrade">Services</a></li>
                                ...
                                <li id="menu-item-1265" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-depth-0 menu-item-simple-parent "><a href="https://github.com/desenvolvedorIcotrade">Contact</a></li>
                            </ul>
                        </nav>
                        <!--nav ends-->
                    </div>
        ...
        <div class="top-content dt-menu-over-slider-container" id="wwwclever-softwarenet">
            <div class="tp-banner-container">
                <div class="tp-banner">
                    <div id="slider">
                        ...
                        <div id="rev_slider_1_1_wrapper" class="rev_slider_wrapper fullscreen-container" style="background-color:rgb(255, 154, 154);padding:0px;">
                    ...
                    <div class='fullwidth-section  '>
                        <div class="container">
                            ...
                            <div class="main-title aligncenter">
                                <h2 class="">Contact<span class="wlast"> Brasil </span><span class="small-line"></span>
                                </h2>
                            </div>
                            <p class="grey" style="text-align: center; margin-bottom: 0;"> use o formulário abaixo para nos enviar uma mensagem:</p>
                        ...
                        <div class="container">
                            ...
                            <div class='column dt-sc-one-half    '>
                                <div class="dt-sc-contact-info">
                                    ...
                                    <p><i class="fa fa-map-marker"></i>Petropolis<br>1077 </p>
                                    <p><i class="fa fa-phone"></i>+55 (47)997511535 ou (47) 34637948 </p>
                                    ...
                                    <div class="dt-sc-margin15"></div>
                                    <h5 class="border-title margin25">  
                                            Junior Full Stack Developer Formação Acadêmica Especialização - 
                                            informatica Manutenção de Micros Computadores e Redes Microlins -
                                            Joinville, SC Agosto de 2004 a Dezembro de 2006
            ...
            <footer>
                <div class="copyright">
                    <!--container starts-->
                    <div class="container">
                        <p> ClevertonKlei Developer <a href="https://github.com/desenvolvedorIcotrade" title=""> Design Theme </a></p>
                    </div>
                    <!--container ends-->
                </div>
            </footer>
